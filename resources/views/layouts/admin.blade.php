        ...
        <div class="min-h-screen lg:grid lg:grid-cols-[240px_1fr]">
            <aside class="border-b border-teal-950/10 bg-[#073f3d] text-white lg:min-h-screen lg:border-b-0 lg:border-r">
                ...
                <nav class="border-t border-white/10 px-3 py-3 lg:py-5">
                    ...
                    <a href="{{ route('admin.operadores') }}" wire:navigate
                              class="mt-1 block rounded-md px-3 py-2 text-sm font-medium {{ request()->routeIs('admin.operadores') ? 'bg-white/15 text-white' : 'text-teal-50/75 hover:bg-white/10 hover:text-white' }}">
                        Gestão de Operadores
                    </a>
                    <a href="{{ route('admin.simulador-notificacoes') }}" wire:navigate
                              class="mt-1 block rounded-md px-3 py-2 text-sm font-medium {{ request()->routeIs('admin.simulador-notificacoes') ? 'bg-white/15 text-white' : 'text-teal-50/75 hover:bg-white/10 hover:text-white' }}">
                    ...
                    <a href="{{ route('admin.relatorios') }}" wire:navigate
                              class="mt-1 block rounded-md px-3 py-2 text-sm font-medium {{ request()->routeIs('admin.relatorios') ? 'bg-white/15 text-white' : 'text-teal-50/75 hover:bg-white/10 hover:text-white' }}">
                        Relatórios
                    </a>
                    <a href="{{ route('admin.admins') }}" wire:navigate
                              class="mt-1 block rounded-md px-3 py-2 text-sm font-medium {{ request()->routeIs('admin.admins') ? 'bg-white/15 text-white' : 'text-teal-50/75 hover:bg-white/10 hover:text-white' }}">
                        Administradores
                    </a>
                </nav>
            </aside>
